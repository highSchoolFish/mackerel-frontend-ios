...
class RegisterSchoolViewController: UIViewController, UITextFieldDelegate {
    weak var delegate: IndexDelegate?
    
//    private let RegisterViewModel.shared = RegisterRegisterViewModel.shared()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("SchoolviewWillAppear")
        delegate?.indexUpdate(1)
    ...
    private func setupAutoLayout(){
        NSLayoutConstraint.activate([
            ...
            schoolLabel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 0),
...
extension RegisterSchoolViewController: UIImagePickerControllerDelegate {
...
extension RegisterSchoolViewController: UINavigationControllerDelegate {
    
}

extension RegisterSchoolViewController: UITableViewDelegate, UITableViewDataSource {
