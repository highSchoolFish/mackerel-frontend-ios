//
//  NationwideCommunityViewController.swift
//  HighSchoolFish_MVVM
//
...
class NationwideCommunityViewController: UIViewController {
...
//            topImageView.topAnchor.constraint(equalTo: topView.topAnchor, constant: 40),
